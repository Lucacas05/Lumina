...
import type { CanvasRemotePlayer, SanctuaryCanvasHandle, SceneKind } from "@/lib/sanctuary/canvas/types";
...
export const SanctuaryCanvasViewport = forwardRef<SanctuaryCanvasHandle, SanctuaryCanvasViewportProps>(
  function SanctuaryCanvasViewport({ sceneKind, avatar, className }, ref) {
    ...
    useEffect(() => {
      ...
      const engine = new SanctuaryCanvasEngine(canvasRef.current, sceneKind, avatar);
