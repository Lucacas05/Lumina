    ...
    <div className="grid gap-6 xl:grid-cols-12">
        ...
        <div className="relative overflow-hidden bg-surface-container-highest pixel-border">
          ...
          <div className="relative flex h-full flex-col gap-6 p-8 md:flex-row md:items-center">
            <div className="shrink-0">
              <PixelAvatar avatar={summary.profile.avatar} state="idle" size="lg" highlighted={true} />
            </div>
            <div className="flex-1">
              <p className="font-headline text-[10px] font-bold uppercase tracking-[0.25em] text-outline">Pulso real del archivo</p>
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-3">
                <div className="border-l-4 border-primary bg-surface-container-low px-4 py-3">
                  <p className="font-headline text-[10px] font-bold uppercase tracking-[0.25em] text-outline">Sesiones</p>
                  <p className="mt-2 font-headline text-2xl font-black text-primary">{summary.sessionsCount}</p>
                </div>
                <div className="border-l-4 border-tertiary bg-surface-container-low px-4 py-3">
                  <p className="font-headline text-[10px] font-bold uppercase tracking-[0.25em] text-outline">Horas de foco</p>
                  <p className="mt-2 font-headline text-2xl font-black text-tertiary">{summary.focusHours} h</p>
                </div>
                <div className="border-l-4 border-secondary bg-surface-container-low px-4 py-3">
                  ...
                  <p className="mt-2 font-headline text-2xl font-black text-secondary">{summary.streakDays} días</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="xl:col-span-5">
        <div className="grid h-full gap-4">
          <a href="/estudio" className="bg-surface-container-low pixel-border p-5 transition hover:bg-surface-container">
          ...
          <a href="/biblioteca-compartida" className="bg-surface-container-low pixel-border p-5 transition hover:bg-surface-container">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="font-headline text-[10px] font-bold uppercase tracking-[0.25em] text-outline">Ruta social</p>
                <h3 className="mt-2 font-headline text-xl font-black uppercase tracking-tight text-tertiary">Biblioteca compartida</h3>
                <p className="mt-2 text-sm leading-relaxed text-on-surface-variant">Sala pública, salas privadas e invitaciones a tu círculo.</p>
              </div>
              <Users size={20} className="text-tertiary" />
            </div>
          </a>

          <a href="/cronicas" className="bg-surface-container-low pixel-border p-5 transition hover:bg-surface-container">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="font-headline text-[10px] font-bold uppercase tracking-[0.25em] text-outline">Archivo</p>
                <h3 className="mt-2 font-headline text-xl font-black uppercase tracking-tight text-secondary">Crónicas e hitos</h3>
              ...
              {summary.latestChronicle ? <BookOpen size={20} className="text-secondary" /> : <Sparkles size={20} className="text-secondary" />}
            </div>
          </a>
        </div>
      </div>
