    ...
    <div className="space-y-8">
      ...
      <section className="relative h-[450px] overflow-hidden bg-surface-container-lowest pixel-border">
        ...
        <div className="absolute bottom-12 left-8 max-w-2xl">
          ...
          <div className="flex gap-4 mt-6">
            <PixelButton size="lg" icon="BookOpen">Enter Study</PixelButton>
            <PixelButton variant="tertiary" size="lg">View Log</PixelButton>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="flex items-center justify-between mb-8">
          ...
          <button className="text-primary font-headline font-bold uppercase text-xs tracking-widest flex items-center gap-1 hover:underline">
            Expand Maps <ICONS.ArrowUpRight size={14} />
          </button>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <div className="md:col-span-8 bg-surface-container-high border-4 border-surface-container-highest p-1 group cursor-pointer overflow-hidden">
          ...
          <div className="md:col-span-4 bg-surface-container-high border-4 border-surface-container-highest p-1 group cursor-pointer overflow-hidden">
          ...
          <div className="md:col-span-3">
            <PixelCard variant="low" className="h-full flex flex-col gap-4">
              ...
              <PixelButton variant="ghost" fullWidth className="mt-auto border-2 border-primary">Enter</PixelButton>
            </PixelCard>
          </div>
          ...
          <div className="md:col-span-3">
            <PixelCard variant="low" className="h-full flex flex-col gap-4">
              ...
              <PixelButton variant="ghost" fullWidth className="mt-auto border-2 border-tertiary">Join</PixelButton>
            </PixelCard>
          </div>
